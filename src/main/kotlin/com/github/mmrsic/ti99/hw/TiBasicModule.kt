...
class TiBasicModule : TiModule {
    ...
    private fun defaultCharacterPattern(code: Int): String {
        return when (code) {
            toAsciiCode('0') -> "0038444444444438"
            toAsciiCode('1') -> "0010301010101038"
            toAsciiCode('2') -> "003844040810207C"
            toAsciiCode('3') -> "0038440418044438"
            toAsciiCode('4') -> "00081828487C0808"
            toAsciiCode('5') -> "007C407804044438"
            toAsciiCode('6') -> "0018204078444438"
            toAsciiCode('7') -> "007C040810202020"
            toAsciiCode('8') -> "0038444438444438"
            toAsciiCode('9') -> "003844443C040830"
            toAsciiCode('A') -> "003844447C444444"
            toAsciiCode('a') -> "00000038447C4444"
            toAsciiCode('B') -> "0078242438242478"
            toAsciiCode('b') -> "0000007824382478"
            toAsciiCode('C') -> "0038444040404438"
            toAsciiCode('c') -> "0000003C4040403C"
            toAsciiCode('D') -> "0078242424242478"
            toAsciiCode('d') -> "0000007824242478"
            toAsciiCode('E') -> "007C40407840407C"
            toAsciiCode('e') -> "0000007C4078407C"
            toAsciiCode('F') -> "007C404078404040"
            toAsciiCode('f') -> "0000007C40784040"
            toAsciiCode('G') -> "003C40405C444438"
            toAsciiCode('g') -> "0000003c405c4438"
            toAsciiCode('H') -> "004444447C444444"
            toAsciiCode('h') -> "00000044447c4444"
            toAsciiCode('I') -> "0038101010101038"
            toAsciiCode('i') -> "0000003810101038"
            toAsciiCode('J') -> "0004040404044438"
            toAsciiCode('j') -> "0000000808084830"
            toAsciiCode('K') -> "0044485060504844"
            toAsciiCode('k') -> "0000002428302824"
            toAsciiCode('L') -> "004040404040407C"
            toAsciiCode('l') -> "000000404040407C"
            toAsciiCode('M') -> "00446C5454444444"
            toAsciiCode('m') -> "000000446C544444"
            toAsciiCode('N') -> "00446464544C4C44"
            toAsciiCode('n') -> "0000004464544C44"
            toAsciiCode('O') -> "007C44444444447C"
            toAsciiCode('o') -> "0000007C4444447C"
            toAsciiCode('P') -> "0078444478404040"
            toAsciiCode('p') -> "0000007844784040"
            toAsciiCode('Q') -> "0038444444544834"
            toAsciiCode('q') -> "0000003844544834"
            toAsciiCode('R') -> "0078444478504844"
            toAsciiCode('r') -> "0000007844784844"
            toAsciiCode('S') -> "0038444038044438"
            toAsciiCode('s') -> "0000003C40380478"
            toAsciiCode('T') -> "007C101010101010"
            toAsciiCode('t') -> "0000007C10101010"
            toAsciiCode('U') -> "0044444444444438"
            toAsciiCode('u') -> "0000004444444438"
            toAsciiCode('V') -> "0044444428281010"
            toAsciiCode('v') -> "0000004444282810"
            toAsciiCode('W') -> "0044444454545428"
            toAsciiCode('w') -> "0000004444545428"
            toAsciiCode('X') -> "0044442810284444"
            toAsciiCode('x') -> "0000004428102844"
            toAsciiCode('Y') -> "0044442810101010"
            toAsciiCode('y') -> "0000004428101010"
            toAsciiCode('Z') -> "007C04081020407C"
            toAsciiCode('z') -> "0000007C0810207C"
            toAsciiCode('!') -> "0010101010100010"
            toAsciiCode('"') -> "0028282800000000"
            toAsciiCode('#') -> "0028287C287C2828"
            ...
            toAsciiCode('+') -> "000010107C101000"
            toAsciiCode(',') -> "0000000000301020"
            toAsciiCode('-') -> "000000007C000000"
            toAsciiCode('.') -> "0000000000003030"
            toAsciiCode('/') -> "0000040810204000"
            toAsciiCode(':') -> "0000303000303000"
            toAsciiCode(';') -> "0000303000301020"
            toAsciiCode('<') -> "0008102040201008"
            toAsciiCode('>') -> "0020100804081020"
            toAsciiCode('=') -> "0000007C007C0000"
            toAsciiCode('?') -> "0038440408100010"
            toAsciiCode('@') -> "0038445C545C4038"
            toAsciiCode('[') -> "0038202020202038"
            toAsciiCode(']') -> "0038080808080838"
            toAsciiCode('\\') -> "0000402010080400"
            toAsciiCode('^') -> "0000102844000000"
            toAsciiCode('_') -> "000000000000007C"
